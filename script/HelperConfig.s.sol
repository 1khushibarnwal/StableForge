...
contract HelperConfig is Script {
    ...
    /**
     * @notice Get or create anvil eth config, a public state-modifying contract function.
     * @return anvilEthConfig A NetworkConfig value.
     * @custom:signature getOrCreateAnvilEthConfig()
     * @custom:selector 0x12900da8
     */
