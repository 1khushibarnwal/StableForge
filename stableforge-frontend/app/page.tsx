...
const FEATURES = [
  {
    ...
    desc: "200% collateral ratio ensures the protocol stays solvent at all times.",
  },
  {
    icon: Zap,
    title: "Instant Minting",
    desc: "Deposit WETH or WBTC and mint SFC stablecoins in a single transaction.",
  },
  {
    icon: TrendingUp,
    title: "Chainlink Oracles",
    desc: "Real-time price feeds for accurate collateral valuation and liquidations.",
  },
  {
    icon: Lock,
    title: "Liquidation Engine",
    desc: "10% bonus incentivizes liquidators to keep the protocol healthy.",
  },
];
    ...
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "700px" }}>
          ...
          >
            Deposit WETH or WBTC as collateral and mint{" "}
            <strong style={{ color: "var(--text-primary)" }}>SFC</strong> — a
            USD-pegged stablecoin secured by overcollateralization, Chainlink
            price feeds, and an on-chain liquidation engine.
          </p>
          ...
          {[
            {
              ...
              desc: "Approve and deposit WETH or WBTC into the SFCEngine contract.",
            },
            {
              step: "02",
              title: "Mint SFC",
              desc: "Mint up to 50% of your collateral value as SFC stablecoins.",
            },
            {
              step: "03",
              title: "Manage Position",
              desc: "Monitor health factor, redeem collateral, or burn SFC to stay safe.",
            },
          ].map(({ step, title, desc }) => (
            <div
              key={step}
